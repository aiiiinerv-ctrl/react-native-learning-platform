...
import { getModuleData, getLessonData } from '@/data/curriculum';

export default function LessonPageClient({ params }: { params: Promise<{ level: string; moduleId: string; lessonId: string }> }) {
